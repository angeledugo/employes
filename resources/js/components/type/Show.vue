                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="type in types" :key="type.id">
                                ...
                                <td>{{ type.name }}</td>
                                <td>
                                    <router-link :to='{name:"typeEdit",params:{id:type.id}}' class="btn btn-primary"><i class="fa fa-edit"></i></router-link>
                                    <a type="button" @click="borrarTipo(type.id)" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
